...
tissue_specific_prior_precision_file = output_dir + trait_name + '_' + gene_version + '_count_genes_once_null_init_tissue_specific_prior_precision_temp.txt'
...
# open output file
output_file = output_dir + trait_name + '_' + chrom_num + '_summary_tgfm_results_' + gene_version + '_tissue_specific_prior.txt'
...
for line in f:
	...
	if pickled_data_file == 'NA':
		...
		tgfm_twas_pkl_file = output_dir + trait_name + '_' + component_name + '_' + gene_version + '_tgfm_twas_tissue_specific_prior_results.pkl'
		...
		# TGFM RSS Regression
		tgfm_rss_regression_fm_results_table_file = output_dir + trait_name + '_' + component_name + '_' + gene_version + '_tgfm_rss_regression_fine_mapping_tissue_specific_prior_table.txt'
		tgfm_rss_fm_obj_regr.posterior_prob_df.to_csv(tgfm_rss_regression_fm_results_table_file, sep='\t', index=False)
		tgfm_rss_regression_tissue_fm_results_table_file = output_dir + trait_name + '_' + component_name + '_' + gene_version + '_tgfm_rss_regression_tissue_fine_mapping_tissue_specific_prior_table.txt'
