...
def infer_rss_twas_tissue_specific_priors(ordered_tissue_names, twas_pickle_file_names, temp_output_file, temp_output_file2, gene_count_method, init_version, max_iter=200):
	# Number of tissues
