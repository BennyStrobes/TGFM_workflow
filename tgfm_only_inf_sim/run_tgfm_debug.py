...
def tgfm_inference_shell(tgfm_data, gene_log_prior, var_log_prior, gene_variant_full_ld, init_method, attenuated_gene_variances):
...
for line in f:
	...
	if window_name != 'chr1_178734349_181734349':
		continue
	...
	tgfm_data['gene_eqtl_pmces'], attenuated_gene_variances = standardize_eqtl_pmces(tgfm_data['gene_eqtl_pmces'], tgfm_data['gene_variances'], tgfm_data['reference_ld'])
	...
	# Run TGFM
	###############################
	tgfm_obj = tgfm_inference_shell(tgfm_data, gene_log_prior, var_log_prior, gene_variant_full_ld, init_method, attenuated_gene_variances)
