...
def create_file_containing_list_of_gene_models_tested_by_tgfm(gtex_susie_gene_models_dir, tgfm_gene_list_file, tgfm_gene_tissue_list_file, gene_type):
	...
	for tissue_name in os.listdir(gtex_susie_gene_models_dir):
		...
		if tissue_name == 'temp':
			continue
		if tissue_name == 'organize_gene_model_data_for_pub_driver.sh':
			continue
		if tissue_name == 'organize_gene_model_data_for_pub.py':
			continue
		if tissue_name == 'organize_gene_model_data_for_pub.sh':
			continue
...
pops_enrichment_dir = pops_enrichment_dir + gene_type + '_'
...
for trait_name in valid_trait_names:
	...
	gene_to_tgfm_gene_pip, gene_to_tgfm_pmces, gene_to_max_abs_twas_z = get_tgfm_genes_and_pips_for_this_trait(trait_name, tgfm_results_dir, tgfm_organized_results_dir, preprocessed_tgfm_data_dir, gene_type)
