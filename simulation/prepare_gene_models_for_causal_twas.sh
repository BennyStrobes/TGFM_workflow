...
python3 prepare_gene_models_for_causal_twas_pt1.py $input_causal_eqtl_effects_file $simulated_learned_gene_models_stem $genotype_bim_file $tmp_pos_file $gene_model_output_root
