...
def extract_gene_tissue_pairs_and_associated_gene_models_in_window(window_start, window_end, gene_summary_file, simulated_learned_gene_models_dir, simulation_name_string, window_indices, simulated_gene_expression_dir, ld_mat, eqtl_type, n_bs):
	...
	for line in f:
		...
		if gene_tss >= (window_start + 100000) and gene_tss <= (window_end - 100000):
			...
			# Fitted gene file
			if eqtl_type == 'susie':
				fitted_gene_file = simulated_learned_gene_models_dir + simulation_name_string + '_' + ensamble_id + '_lasso_gene_model_pmces.npy'
...
tgfm_input_data_summary_file = simulated_tgfm_input_data_dir + simulation_name_string + '_' + eqtl_type + '_lasso_tgfm_input_data_summary.txt'
...
for line in f:
	...
	gene_tissue_pairs, gene_tissue_pairs_tss, pmces_weights, gene_variances = extract_gene_tissue_pairs_and_associated_gene_models_in_window(window_start, window_end, gene_summary_file, simulated_learned_gene_models_dir, simulation_name_string, window_indices, simulated_gene_expression_dir,ld_mat, eqtl_type, n_bs)
	...
	window_pickle_output_file = simulated_tgfm_input_data_dir + simulation_name_string + '_' + window_name + '_' + eqtl_type + '_tgfm_lasso_input_data.pkl'
