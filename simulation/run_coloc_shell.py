...
output_file = simulated_coloc_results_dir + simulation_name_string + '_eqtlss_' + str(eqtl_sample_size) + '_coloc_results.txt'
print(output_file)
...
for line in f:
	...
	eqtl_betas_file = simulated_learned_gene_models_dir + simulation_name_string + '_' + ensamble_id + '_eqtlss_' + str(eqtl_sample_size) + '_marginal_beta.npy'
	eqtl_betas = np.load(eqtl_betas_file)
	eqtl_beta_var_file = simulated_learned_gene_models_dir + simulation_name_string + '_' + ensamble_id + '_eqtlss_' + str(eqtl_sample_size) + '_marginal_beta_var.npy'
