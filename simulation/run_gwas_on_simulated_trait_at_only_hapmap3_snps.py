...
# Extract dictionary list of hapmap3 rsids (ie regression snps in sldsc)
####################################################
hm3_rsid_file = ldsc_weights_dir + 'hm3_noMHC.' + chrom_num + '.rsid'
hapmap3_rsids = extract_dictionary_list_of_hapmap3_rsids(hm3_rsid_file)
...
gwas_output_file = simulated_gwas_dir + simulation_name_string + '_simualated_gwas_results_hm3_noHMC_snps_only.txt'
run_gwas_on_hm3_rsids(hapmap3_rsids, trait_values_file, gwas_plink_stem, gwas_output_file)
