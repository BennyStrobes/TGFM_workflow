...
make_tgfm_manhatten_plot_for_given_window_paper_ready <- function(snp_df, gene_df, trait_name, train_name_readable, window_name, gene_x_nudge=0.4, variant_x_nudge=-0.4, add_nominal_sig_lines=FALSE, add_twas_nominal_sig_lines=FALSE, add_nm_variant_text=FALSE, variant_scaler=.1) {
	# Convert snp_df and gene_df to MB
	snp_df$snp_position_mb = snp_df$snp_position/1000000.0
	gene_df$gene_tss_mb = gene_df$gene_tss/1000000.0
	...
	print(dim(gene_df2[(twas_p <= 2.5*10^-6) & gene_df2$TGFM_PIP <= .01,]))
	print((gene_df2[(twas_p <= 2.5*10^-6) & gene_df2$TGFM_PIP <= .01,]))
	...
	if (add_nominal_sig_lines==TRUE) {
		pp = pp +geom_hline(yintercept=-log10(2.5*10^-6), color=brewer.pal(n = 9, name = "Reds")[4], linetype='dotted')+
...
# Make manhatten plot for a given window/trait
tgfm_manhatten_plot1 <- make_tgfm_manhatten_plot_for_given_window_paper_ready(snp_df, gene_df, trait_name, trait_name_readable, window_name, add_nominal_sig_lines=TRUE)
...
# Make manhatten plot for a given window/trait
tgfm_manhatten_plot2 <- make_tgfm_manhatten_plot_for_given_window_paper_ready(snp_df, gene_df, trait_name, trait_name_readable, window_name, add_nominal_sig_lines=FALSE, add_twas_nominal_sig_lines=TRUE)
...
# Make manhatten plot for a given window/trait
tgfm_manhatten_plot3 <- make_tgfm_manhatten_plot_for_given_window_paper_ready(snp_df, gene_df, trait_name, trait_name_readable, window_name, add_nominal_sig_lines=TRUE, add_nm_variant_text=TRUE)
...
# Make manhatten plot for a given window/trait
tgfm_manhatten_plot4 <- make_tgfm_manhatten_plot_for_given_window_paper_ready(snp_df, gene_df, trait_name, trait_name_readable, window_name, add_nominal_sig_lines=TRUE)
...
# Make manhatten plot for a given window/trait
tgfm_manhatten_plot1 <- make_tgfm_manhatten_plot_for_given_window_paper_ready(snp_df, gene_df, trait_name, trait_name_readable, window_name, add_nominal_sig_lines=TRUE, add_nm_variant_text=TRUE, variant_scaler=.01)
...
# Make manhatten plot for a given window/trait
tgfm_manhatten_plot2 <- make_tgfm_manhatten_plot_for_given_window_paper_ready(snp_df, gene_df, trait_name, trait_name_readable, window_name, add_nominal_sig_lines=TRUE)
...
# Make manhatten plot for a given window/trait
tgfm_manhatten_plot3 <- make_tgfm_manhatten_plot_for_given_window_paper_ready(snp_df, gene_df, trait_name, trait_name_readable, window_name, add_nominal_sig_lines=TRUE)
...
# Make manhatten plot for a given window/trait
tgfm_manhatten_plot4 <- make_tgfm_manhatten_plot_for_given_window_paper_ready(snp_df, gene_df, trait_name, trait_name_readable, window_name, variant_x_nudge=.4, add_nominal_sig_lines=TRUE, add_nm_variant_text=TRUE)
...
# Make manhatten plot for a given window/trait
tgfm_manhatten_plot5 <- make_tgfm_manhatten_plot_for_given_window_paper_ready(snp_df, gene_df, trait_name, trait_name_readable, window_name, add_nominal_sig_lines=TRUE)
...
# Make manhatten plot for a given window/trait
tgfm_manhatten_plot6 <- make_tgfm_manhatten_plot_for_given_window_paper_ready(snp_df, gene_df, trait_name, trait_name_readable, window_name, add_twas_nominal_sig_lines=TRUE)
