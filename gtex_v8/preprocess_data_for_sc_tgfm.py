...
def create_tissue_to_gene_model_df(pseudotissues, gtex_susie_gene_models_dir,cell_types, sc_pbmc_susie_gene_models_dir, gene_type):
	mapping = {}
	...
	for cell_type in cell_types:
		gene_model_summary_file = sc_pbmc_susie_gene_models_dir + cell_type + '/' + cell_type + '_' + gene_type + '_pos_file.txt'
		raw_table = np.loadtxt(gene_model_summary_file, dtype=str, delimiter='\t')[1:]
		mapping[cell_type] = raw_table
	return mapping
...
cell_types = get_cell_type_names(pb_cell_type_file)

# Create dictionary from pseudotissue to array of gene models for that tissue
tissue_to_gene_model_df = create_tissue_to_gene_model_df(pseudotissues, gtex_susie_gene_models_dir, cell_types, sc_pbmc_susie_gene_models_dir, gene_type)

# Concatetate pseudotissues and cell_types
