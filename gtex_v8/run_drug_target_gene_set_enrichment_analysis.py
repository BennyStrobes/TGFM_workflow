...
t.write('trait_name\tgene_name\tensamble_id\ttgfm_gene_pip\ttgfm_abs_gene_pmces\tmax_abs_twas_z\tdrug_target_gene\n')
...
for trait_name in trait_names:
	...
	for ensamble_id in tgfm_ensamble_ids:
		...
		t.write(trait_name + '\t' + gene_symbol_id + '\t' + ensamble_id + '\t' + str(gene_to_tgfm_gene_pip[ensamble_id]) + '\t' + str(abs(gene_to_tgfm_pmces[ensamble_id])) + '\t' + str(gene_to_max_abs_twas_z[ensamble_id]) + '\t' +  str(boolean) + '\n')
	t.flush()
t.close()
