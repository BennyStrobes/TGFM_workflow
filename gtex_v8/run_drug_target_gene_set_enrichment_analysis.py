...
drug_target_gene_list_file = sys.argv[6]
drug_target_gene_set_enrichment_dir = sys.argv[7]
...
for trait_name in trait_names:
	...
	'''
	tgfm_prioritized_genes_weighted = get_tgfm_prioritized_genes_based_on_weighting(tgfm_results_dir, trait_name, gene_type, ensg_to_gene_symbol,lower_thresh=.1)
	# Compute odds ratio contingency table
	print(trait_name)
	aa, bb, cc, dd = compute_weighted_contingency_table(drug_target_gene_dicti, tgfm_prioritized_genes_weighted, tgfm_tested_genes_dicti)
...
print(scipy.stats.fisher_exact(table_1))

print(scipy.stats.fisher_exact(table_25))
print(scipy.stats.fisher_exact(table_5))
