...
def simulate_gene_expression_shell(simulated_causal_eqtl_effect_summary_file, eqtl_sample_size, simulation_name_string, processed_genotype_data_dir, chrom_num):
...
simulation_name_string = sys.argv[6]
