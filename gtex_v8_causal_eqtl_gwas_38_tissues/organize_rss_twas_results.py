...
output_file = pseudotissue_gtex_rss_multivariate_twas_dir + trait_name + '_' + gene_version + '_fusion_weights_' + fusion_weights + '_component_organized_tgfm_results.txt'
t = open(output_file,'w')
t.write('trait_component\ttissue\tgene\tnominal_fusion_twas_z_score\ttgfm_const_prior_twas_alpha\ttgfm_tissue_prior_twas_alpha\trobust_tgfm_tissue_prior_twas_alpha\ttgfm_const_prior_twas_alpha_var\ttgfm_tissue_prior_twas_alpha_var\trobust_tgfm_tissue_prior_twas_alpha_var\ttgfm_const_prior_twas_z_score\ttgfm_tissue_prior_twas_z_score\trobust_tgfm_tissue_prior_twas_z_score\ttgfm_rss_regression_const_prior_posterior_prob\ttgfm_rss_regression_tissue_prior_posterior_prob\trobust_tgfm_rss_regression_tissue_prior_posterior_prob\trobust_tgfm_rss_regression_tissue_prior_log_likelihood\n')
