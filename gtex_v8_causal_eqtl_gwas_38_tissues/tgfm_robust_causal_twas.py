...
class TGFM_CAUSAL_TWAS(object):
	def __init__(self, max_iter=200, convergence_thresh=1e-5, estimate_prior_variance=False,fusion_weights=False, prior_variance=1000, pleiotropic_prior_variance=1000, prior_variance_vector=None, ard_a_prior=1e-16, ard_b_prior=1e-16):
